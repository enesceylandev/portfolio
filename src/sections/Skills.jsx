...
const Skills = () => {
  ...
  const translateX = -scrollX + 11250;
  return (
    <div className="flex items-center relative h-screen mt-0 overflow-x-hidden">
      ...
      <div className='grid md:grid-cols-5 md:space-y-0 space-y-12 mx-12 w-full text-left top-0 text-3xl z-10 align-top items-start'>
        ...
        <div className='md:col-start-4 lg:col-start-5 md:col-span-2 col-span-5'>
        ...
        <div className='md:col-start-3 md:row-start-2 md:col-span-3 col-span-5'>
          <h2 className='font-bold'>Other Skills</h2>
          <p>Product Design</p>
          <p>Design system</p>
