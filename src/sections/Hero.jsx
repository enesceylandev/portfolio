...
const Hero = () => {
  return (
    <div className='relative overflow-hidden flex flex-col mx-2 sm:w-[650px] sm:h-56 text-[#303030]'>
      <motion.div 
        className='sm:relative left-0'
        initial={{ opacity: 0, y: -300, zIndex:20}}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.5, delay: 0.5 }}>
      <img src={myPic} alt="" className=' w-32 sm:w-56 sm:absolute mx-auto left-0 right-0 sm:mx-0 sm:left-7 sm:right-0 z-20'/>
      </motion.div>
      <motion.div 
